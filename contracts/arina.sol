...
contract arina is setOperator{
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        require(_value <= allowance[_from][msg.sender], "allowance ERROR !!");     // Check allowance
    ...
    function mintToken(address _target, uint256 _mintedAmount) public onlyManager {
